...
export default function LocalContractsTabWrapper() {
  ...
  return (
    <div className="w-full">
      {/* Fixed Tabs Header */}
      <div className="sticky top-[64px] z-30 w-full bg-[#F9F9FA] dark:bg-gray-900 border-b border-gray-300 dark:border-gray-700">
          ...
          {tabs.map((tab: TTab) => (
            <div
              ...
              className={`relative cursor-pointer flex-1 text-center py-4 px-2 sm:px-4 transition-colors duration-200
                ${selectedTab === tab.key ? "text-primary font-semibold" : "text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"}`}
            >
              {tab.label}
