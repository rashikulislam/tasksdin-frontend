    ...
    <div className="py-6 max-w-2xl mx-auto space-y-4">
      ...
      <Tabs defaultValue="didit">
        ...
        <TabsContent value="didit" className="mt-4">
          <DiditKycVerification dashboardPath="/dashboard/consumer" />
        </TabsContent>

        <TabsContent value="manual" className="mt-4">
          <KycSubmitForm dashboardPath="/dashboard/consumer" />
        </TabsContent>
      </Tabs>
    </div>
  );
...
export default ConsumerKycPage;
